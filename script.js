...
fetch(`https://openapi.programming-hero.com/api/ai/tools`)
    ...
    .then((value) => {
        ...
        // let features = [];
        // for (let i = 0; i < 3; i++) {
        //     features.push(`${i + 1}. ${data[0].features[i]}`)
        // }
        ...
        // div.innerHTML = `
        //     <div class="border-2 p-3 shadow-md">
        //         <img class="rounded-md" src="${data[0].image}" alt="">
        ...
        //         <h2 class="font-bold text-[20px] text-start">${data[0].name}</h2>
        //         <p class="text-start"><i class="fa-solid fa-calendar-days pr-2"></i> ${data[0].published_in}</p>
        //     </div>
        // `
        ...
        for (let id = 0; id < 6; id++) {
            ...
            newDiv.classList.add("border-2", "p-5", "shadow-md", "rounded-lg", "transform", "hover:scale-105", "transition", "duration-300")
